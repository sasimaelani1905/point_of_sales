...
$q_detail = mysqli_query($koneksi, "SELECT * FROM tbl_detail_nota_jual WHERE kode_nota = '$kode_nota'") or die(mysqli_error($koneksi));
...
$pdf->Cell(50, 5, 'NOTA PENJUALAN', 0, 1, 'C');
...
// ==================== DETAIL BARANG ====================
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(50, 4, 'DETAIL PENJUALAN', 0, 1, 'L');
$pdf->Ln(1);
...
// ==================== FOOTER ====================
$pdf->SetFont('Arial', '', 7);
$pdf->Cell(50, 3.5, 'Terima kasih atas penjualan Anda', 0, 1, 'C');
$pdf->Cell(50, 3.5, 'Selamat berbelanja kembali', 0, 1, 'C');

// Output PDF Stream
$pdf->Output('I', 'Nota-' . $kode_nota . '.pdf');
?>