...
if (!$kode_nota) {
    echo "<script>alert('Kode Nota Tidak Ditemukan!'); window.location.href='kasir_nota_beli';</script>";
    exit;
}
...
if (isset($_POST['tambah_detail_beli'])) {
    ...
    if ($simpan) {
        ...
        echo "<script>alert('Barang berhasil ditambahkan & stok bertambah!'); window.location.href='kasir_detail_nota_beli?kode_nota=$kode_nota';</script>";
    } else {
...
if (isset($_GET['aksi']) && $_GET['aksi'] == 'hapus') {
    ...
    if ($query_hapus) {
        ...
        echo "<script>alert('Item berhasil dihapus & stok dikurangi kembali!'); window.location.href='kasir_detail_nota_beli?kode_nota=$kode_nota';</script>";
    }
}
...
<head>
  ...
  <title>Detail Nota Beli | kasirPOS</title>
  <?php include '../css.php'; ?>
</head>
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <a href="../kasir_nota_beli/" class="btn btn-secondary mb-2"><i class="fas fa-arrow-left"></i> Kembali ke Nota Beli</a>
