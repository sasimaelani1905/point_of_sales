...
if (!$kode_nota) {
    echo "<script>alert('Kode Nota Tidak Ditemukan!'); window.location.href='admin_nota_jual';</script>";
    exit;
}
...
if (isset($_POST['tambah_detail_jual'])) {
    ...
    if ($d_stok['stok'] < $jumlah) {
        echo "<script>alert('Stok barang tidak mencukupi! Stok saat ini: " . $d_stok['stok'] . "'); window.location.href='admin_detail_nota_jual?kode_nota=$kode_nota';</script>";
        exit;
    }
    ...
    if ($simpan) {
        ...
        echo "<script>alert('Barang berhasil dijual & stok berkurang!'); window.location.href='admin_detail_nota_jual?kode_nota=$kode_nota';</script>";
    } else {
...
if (isset($_GET['aksi']) && $_GET['aksi'] == 'hapus') {
    ...
    if ($query_hapus) {
        ...
        echo "<script>alert('Item berhasil dihapus & stok dikembalikan!'); window.location.href='admin_detail_nota_jual?kode_nota=$kode_nota';</script>";
    }
}
...
<head>
  ...
  <title>AdminPOS - Detail Nota Jual</title>
  <?php include '../css.php'; ?>
</head>
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <a href="../admin_nota_jual/" class="btn btn-secondary mb-2"><i class="fas fa-arrow-left"></i> Kembali ke Nota Jual</a>
